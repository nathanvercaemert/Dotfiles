...
#+BEGIN_SRC emacs-lisp
  ;; (defun my-kill-whole-line (append)
  ;;   (interactive)
  ;;   (setq tog-sh-tr-wh nil)
  ;;   (setq line (line-number-at-pos))
  ;;   (setq tot-lines-pre-kill (count-lines (point-min) (point-max)))
  ;;   (if (< 1 line)
  ;;       (progn
  ;;         (previous-line)
  ...
  ;;   (unless (or
  ;;            (and
  ;;             (< (count-lines (point-min) (point-max)) tot-lines-pre-kill)
  ;;             (bobp)
  ;;             ;; (looking-at "\n")
  ;;             )
  ;;            (and (not (bobp))(eolp))
  ...
  ;; (defun my-delete-all-lines-in-region ()
  ;;   (interactive)
  ;;   (setq swap-p-m nil)
  ;;   (setq beg (line-beginning-position))
  ;;   (setq end (line-end-position))
  ...
  ;;         (dotimes (i num-lines)
  ;;           (if (> i 0)
  ;;               (my-kill-whole-line t)
  ;;             (my-kill-whole-line nil)))
  ;;         (if trunc-swap
  ;;             (toggle-truncate-lines))
  ;;         )
  ;;     (my-kill-whole-line nil)
  ...
  ;; (defun my-kill-or-copy-all-lines-in-region ()
  ;;   (interactive)
  ;;   (my-delete-all-lines-in-region)
  ;;   (with-temp-buffer
  ...
  (defun my-kill-or-copy-all-lines-in-region (kill)
    (interactive)
    (let (tr-wh-is-swap trunc-is-swap end (origin (point)))
      (if (not truncate-lines)
          (progn
            (toggle-truncate-lines)
...
** directory
#+BEGIN_SRC emacs-lisp
(setq org-roam-directory (file-truename "/home/nathanvercaemert/Zettelkasten/"))
#+END_SRC
** db autosync
#+BEGIN_SRC emacs-lisp
...
* vterm
#+BEGIN_SRC emacs-lisp
(add-to-list 'load-path "~/Repositories/emacs-libvterm")
(require 'vterm)
#+END_SRC
